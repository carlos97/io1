    ...
    if(fase):
        ...
        for i in range(matriz.shape[0]+4):
            for j in range(matriz.shape[1]+1):
                if (paso>1):
                    Txt3_1=tk.Entry(frame4, width=10)
                else:
                    Txt3_1=tk.Entry(frame3, width=10)
        ...
        for i in range(matriz.shape[0]+4):
            for j in range(matriz.shape[1]+1):
                Txt3_1=tk.Entry(newFrame, width=10)
                Txt3_1.config(font=("Helvetica",15))
                Txt3_1.grid(row=i+1,column=j)
        ...
        Lbl3=tk.Label(finalFrame, text="Resultado")
        Lbl3.config(font=("Helvetica",24))
        Lbl3.grid(pady=5,row=0,column=0, columnspan=matriz.shape[1]+2)
        ...
        for i in range(matriz.shape[0]+4):
            for j in range(matriz.shape[1]+1):
                Txt3_1=tk.Entry(finalFrame, width=10)
                Txt3_1.config(font=("Helvetica",15))
                Txt3_1.grid(row=i+1,column=j)
        ...
        for i in range(len(Var)-1):
            if('X' in Var[i]):
                ...
                if(Var[i] in V_Base):  
                    b=(round(matriz[np.where(np.array(V_Base) == np.array(Var[i]))[0][0]][matriz.shape[1]-1],2))
                    Lbl3_2=tk.Label(finalFrame, text=b)
                else:
                    Lbl3_2=tk.Label(finalFrame, text="0")
                
                Lbl3_2.config(font=("Helvetica",20))
                Lbl3_2.grid(pady=10,row=matriz.shape[0]+(6+i),column=1, columnspan=3)
